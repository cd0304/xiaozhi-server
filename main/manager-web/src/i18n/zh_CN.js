export default {
  ...
  'roleConfig.enableTts': 'TTS语音合成',
  'roleConfig.useGlobalConfig': '使用全局配置',
  'roleConfig.enableTtsOn': '启用TTS',
  'roleConfig.enableTtsOff': '禁用TTS',
  'roleConfig.enableTtsHint': '禁用TTS时，设备将只返回文本响应，不生成语音',
